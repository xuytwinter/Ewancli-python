...
class SkillStateStore:
    def __init__(self, path: str | Path | None = None):
        self.path = Path(path or Path.home() / ".ewancli" / "skills.json").expanduser()
...
class SkillRegistry:
    ...
    def __init__(
        ...
        *,
        ...
        self.user_root = Path(user_root or Path.home() / ".ewancli" / "skills")
        self.project_skill_root = self.project_root / ".ewancli" / "skills"
