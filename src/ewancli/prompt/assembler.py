...
class PromptAssembler:
    ...
    def build_static(self) -> str:
        parts = [
            "You are Ewancli, a powerful AI coding assistant running in a terminal.",
    ...
    def _static_project_instructions(self) -> str:
        paths = [
            ...
            Path(self.cwd) / ".ewancli" / "AGENTS.md",
            Path(self.cwd) / "EWAN.md",
            Path(self.cwd) / ".ewancli" / "EWAN.md",
            Path(self.cwd) / "EWAN.local.md",
            Path(self.cwd) / ".ewancli" / "EWAN.local.md",
        ]
